...
{
    BOOST_CHECK(TestSplitHost("www.planbcoin.org", "www.planbcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.planbcoin.org]", "www.planbcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.planbcoin.org:80", "www.planbcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.planbcoin.org]:80", "www.planbcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:9068", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9068", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9068", "::ffff:127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[::]:9068", "::", 8333));
    BOOST_CHECK(TestSplitHost("::9068", "::8333", -1));
    BOOST_CHECK(TestSplitHost(":9068", "", 8333));
    BOOST_CHECK(TestSplitHost("[]:9068", "", 8333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9068", "127.0.0.1:8333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9068", "[::]:8333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
