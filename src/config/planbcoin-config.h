/* src/config/planbcoin-config.h.  Generated from planbcoin-config.h.in by configure.  */
/* src/config/planbcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Planbcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Planbcoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/planbcoin/planbcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Planbcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Planbcoin Core 0.14.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "planbcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://planbcoincore.org/"
