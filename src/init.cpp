 ...
 * between planbcoind, and planbcoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("planbcoin-shutoff");
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("planbcoin-loadblk");
...
/** Sanity checks
 *  Ensure that Planbcoin is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Planbcoin process is using the data directory.
