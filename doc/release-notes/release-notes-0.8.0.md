Planbcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/planbcoin/files/Planbcoin/planbcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Planbcoin
...
New/changed settings (command-line or planbcoin.conf file)
--------------------------------------------------------
