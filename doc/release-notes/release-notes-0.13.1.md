PlanBcoin version 0.13.1 is now available from:
...
- **More efficient almost-full-node security** Satoshi Nakamoto's original
  ...
  note that PlanBcoin does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  Planbcoin users to individually opt-in to almost any change in the Planbcoin
  Script language when those users receive new transactions.  Features
  currently being researched by PlanBcoin contributors that may use this
...
Since PlanBcoin 0.10.0, nodes have defaulted to only relaying and
