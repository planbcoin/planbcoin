Planbcoin Core version 0.14.0 is now available from:
...
Planbcoin Core has supported automatically pruning the blockchain since 0.11. Pruning
...
When Planbcoin Core is out-of-sync on startup, a semi-transparent information
...
The Alert System was [disabled and deprecated](https://planbcoin.org/en/alert/2016-11-01-alert-retirement) in Planbcoin Core 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Planbcoin Core. This was added in conjunction with
