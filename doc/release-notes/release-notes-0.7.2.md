Planbcoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/planbcoin/files/Planbcoin/planbcoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Planbcoin-Qt to crash on Windows when exiting.
