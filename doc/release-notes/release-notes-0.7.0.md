...
source-only tarballs/zipballs directly from there:
  https://github.com/planbcoin/planbcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/planbcoin/planbcoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the planbcoin-qt package:
  sudo apt-get install planbcoin-qt
...
Planbcoin Improvement Proposals implemented
...
Core planbcoin handling and blockchain database
...
* Ensure a changed planbcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for planbcoin-qt.exe
* (Windows only): add meta-data to planbcoin-qt.exe (e.g. description)
...
* Bash programmable completion for planbcoind(1)
