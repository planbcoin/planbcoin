Planbcoin Core version 0.9.2 is now available from:

  https://planbcoin.org/bin/0.9.2/
...
- Lower paytxfee warning threshold from 0.25 PBC to 0.01 PBC
...
- Fix "Start planbcoin on system login"
