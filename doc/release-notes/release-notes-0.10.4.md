Planbcoin Core version 0.10.4 is now available from:

  <https://planbcoin.org/bin/planbcoin-core-0.10.4/>
...
- #6953 `43c2789` Split planbcoin-tx into its own package
- #6953 `dfe0d4d` Include planbcoin-tx binary on Debian/Ubuntu
