PlanBcoin version 0.11.0 is now available from:
...
Block pruning allows PlanBcoin to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that PlanBcoin will 
