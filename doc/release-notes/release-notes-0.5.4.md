Planbcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/planbcoin/files/Planbcoin/planbcoin-0.5.4/
...
http://gitorious.org/planbcoin/planbcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Planbcoin-Qt notifications under Growl 1.3.
Increase required age of Planbcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPlanbcoin properly when installing Planbcoin-Qt over it. (Windows)
