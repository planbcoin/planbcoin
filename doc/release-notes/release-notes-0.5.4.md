...
Fix PlanBcoin notifications under Growl 1.3.
Increase required age of PlanBcoin's "not up to date" status from 30 to 90 minutes.
...
Remove wxPlanbcoin properly when installing PlanBcoin over it. (Windows)
