Planbcoin version 0.7.1 is now available from:
  http://sourceforge.net/projects/planbcoin/files/Planbcoin/planbcoin-0.7.1/
...
source-only tarballs/zipballs directly from there:
  https://github.com/planbcoin/planbcoin/tarball/v0.7.1  # .tar.gz
  https://github.com/planbcoin/planbcoin/zipball/v0.7.1  # .zip
...
* When running -testnet, use RPC port 19067 by default.
