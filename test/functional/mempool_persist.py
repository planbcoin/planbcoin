#!/usr/bin/env python3
# Copyright (c) 2014-2017 The Planbcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test mempool persistence.

By default, planbcoind will dump mempool on shutdown and
...
class MempoolPersistTest(PlanbcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Give planbcoind a second to reload the mempool
        time.sleep(1)
