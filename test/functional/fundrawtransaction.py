...
from test_framework.test_framework import PlanbcoinTestFramework, BITCOIND_PROC_WAIT_TIMEOUT
...
class RawTransactionsTest(PlanbcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid planbcoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        self.planbcoind_processes[1].wait(timeout=BITCOIND_PROC_WAIT_TIMEOUT)
