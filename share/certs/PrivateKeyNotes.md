...
unlocked to sign the Planbcoin-Qt.app bundle.
...
allowing somebody to distribute a Planbcoin-Qt.app or planbcoin-qt-setup.exe with a valid
...
that the planbcoin-qt.exe file inside the installer had not been tampered with.
